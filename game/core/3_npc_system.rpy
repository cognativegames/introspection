# ============================================================================
# NPC SYSTEM
# Mirror of player system - NPCs have beliefs, emotions, and interpretations
# ============================================================================
...
init python:
    class NPCState:
        ...
        def activate_belief(self, belief_id, intensity):
            """Activate or strengthen a belief"""
        ...
        def detect_belief_conflicts(self):
            """Detect conflicts between active beliefs"""
            conflicts = []
        ...
        def remember_event(self, event_type, other_character_id, description, emotional_impact):
            ...
            memory = {
                ...
                "beliefs_activated": list(self.beliefs.keys())[-3:] if self.beliefs else [],
        ...
        def get_therapy_topic(self):
            ...
            unprocessed = [m for m in self.memories if m["type"] in ["boundary_violation", "trauma_trigger"] and not m.get("processed", False)]
